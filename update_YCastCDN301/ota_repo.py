...
class CLOta_repo:
    ...
    def __init__(self, user, repo, url=None, branch="master", working_dir=None, files=["boot.py", "main.py"], headers={}):
        """ OTA agent class.
        ...
        if( url is None ):
            if( working_dir is None ):
                url = "{}/{}".format(self.base_url, branch)
            else:
                url = "{}/{}/{}".format(self.base_url, branch, working_dir)
